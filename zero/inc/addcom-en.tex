...
As the induction, assume $0 + a = a$ holds, we are going to show that $0 + a' = a'$.
...
For induction case, assume $a + 1 = 1 + a$ holds, we are going to show $a' + 1 = 1 + a'$.
...
It proves the commutativity of addition with Peano's axioms\cite[p147-148]{StepanovRose15}.
