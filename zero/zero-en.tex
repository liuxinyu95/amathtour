...
The definition of multiplication consists of two parts: the product of any natural number and 0 is 0, and the product of $a$ and the successor of $b$ equals $a$ plus the product of $a$ and $bf$. The latter can be expressed as $a \cdot (b+1) = a \cdot b + a \cdot 1$. Let's verify it with $2 \times 3$:
...
\Question{Show that the additive inverse is unique.
  \begin{proof}
    Assume $b$ is another additive inverse of $a$, we are going to show $b = -a$:
    \begin{align*}
...
\begin{proof}
Assume there is another unit $e'$, which satisfies $e' \odot a = a \odot e' = a$ for any element $a$. We are going to show $e = e'$:
\begin{align*}
