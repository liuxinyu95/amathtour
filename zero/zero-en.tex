...
\begin{example}
In the dating system, 1 CE was the year after Jesus Christ's birth, then followed 2 CE, 3 CE, ... For the historic events happened before Jesus Christ's birth, we denote the year with BCE, for example, 1 BCE, 2 BCE, ... The years of BCE illustrate the notion of negative numbers (although lack of year of 0).
\end{example}
