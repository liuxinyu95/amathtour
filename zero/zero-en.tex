...
\Question{Verify the addition and multiplication of pairs are commutative, associative, and the multiplication is distributive over addition.
  ...
  \item Commutative:
    \begin{align*}
      (a, b) + (c, d) & = (a + c, b + d)  & \text{definition of +} \\
                      & = (c + a, d + b)  & \text{commutative of + for } \mathbb{N}\\
                      & = (c, d) + (a, b) & \text{definition of + (converse)}
    \end{align*}
    \begin{align*}
      (a, b) \cdot (c, d) & = (ac + bd, ad + bc) & \text{definition of } $\cdot$ \\
                          & = (ca + db, da + cb) & \text{commutative of $\cdot$ for } \mathbb{N} \\
                          & = (c, d) \cdot (a, b) & \text{definition of $\cdot$ (converse)}
    \end{align*}
  ...
  \item There are two distributive law: from left and from right. We only verify the left one.
    \begin{align*}
        ...
        =& (ac + bd, ad + bc) + (ae + bf, af + be) & \text{definition of + (converse)} \\
        =& (a, b) \cdot (c, d) + (a, b) \cdot (e, f) & \text{definition of $\cdot$ (converse)}
    \end{align*}
  \end{enumerate}
}
...
\Question{Show that $(-1) \times (-1) = 1$ by the distributive law.
  \begin{proof}
    \begin{align*}
      (-1) \times (-1) & = (-1) \times (-1) + 0 & \text{fixed when added to 0} \\
                      & = (-1) \times (-1) + (-1 + 1) & \text{additive inverse} \\
                      & = (-1) \times (-1) + (-1) \times 1 + 1 & \text{fixed when multiply 1} \\
...
\Question{Show that the additive inverse is unique.
  \begin{proof}
    Suppose $b$ is another inverse of $a$, we are going to show $b = -a$:
    \begin{align*}
      0     & = b + a     & \text{inverse} \\
