...
There is a famous object in room 4, the British museum. It's the Rosetta stone, a broken inscribed stone with the length of 112cm, width of 76cm (\cref{fig:rosetta-stone-recons}). One can identifies some Greek characters like \cref{fig:rosetta-greek} (see \cref{tab:greek-alphabet} of Greek alphabet). While the remaining are mystery ancient characters.
