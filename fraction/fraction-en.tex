...
In Analysis, it's common to solve Achilles paradox with the concept of limitation. Alternatively, we may solve it with the tool, namely the decimal as the sum of fractions. Let's quantify the problem for easy understanding. Suppose Achilles was 10 times faster than the tortoise, i.e., $v_2 : v_1 = 10$; the tortoise started a head by the distance $s = 100$ pous\footnote{1 pous $\approx$ 0.308 feet in ancient Greece.}. According to Zeno, Achilles needs first traverse $s = 100$ pous, by which time the tortoise will have moved $\dfrac{1}{10}s = 10$ pous ahead; then Achilles traverses this 10 pous, by which time the tortoise will have moved another$\dfrac{1}{100}s = 1$ pous, ... the total distance Achilles needs to traverse will be:
