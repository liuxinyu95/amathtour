...
\Question{Use fractions and Lemma \ref{th:cycle-of-9} to show: Atalanta first traverses $\dfrac{1}{2}$ distance, then traverses half of the remaining, which is $\dfrac{1}{4}$ distance, and repeats, she will walk to the end of the path. Hint: using sum of fractions and binary decimal.\label{qn:dichotomy-paradox}}
...
\vspace{2mm}
Let $n = 2m$, so that $\dfrac{4}{2m} = \dfrac{2}{m}$, which is proposition \ref{th:decompose-of-2-n}.
}
  ...
  \begin{proof}
    ...
    \begin{align*}
      ...
      \frac{4}{4k + 3} &= \frac{2}{\frac{1}{2}(4k + 4)} + \frac{2}{\frac{1}{2}(4k + 3)(4k + 4)} & \text{substitute } p = 4k + 3 & \\
                       ...
                       &= \frac{1}{k + 2} + \frac{1}{(k + 1)(k + 2)} + \frac{1}{(4k + 3)(k + 1)} & \text{by proposition \ref{th:egyptian-fraction-split}} & \qedhere
    \end{align*}
  \end{proof}
}
