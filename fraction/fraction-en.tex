...
Although very popular, this legend can \emph{not} be the origin of Egyptian fractions. We've found similar stories in many peoples, including the Arabians, the Indians, the Hebrews, the Chinese, and so on. Henry Dudeney collected this puzzle in his popular book \emph{Modern Puzzles and how to solve them} in 1926. In different versions, the animals vary from horses, camels, to elephants; the number and dividing portions vary too, such as, the three sons need to divide 11 animals into portions of $\dfrac{1}{2}$, $\dfrac{1}{4}$, and $\dfrac{1}{6}$, which corresponds to:
