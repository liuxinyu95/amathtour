...
The Laser Interferometer Gravitational-Wave Observatory (LIGO), an astronomical observatory, in USA detected the first gravitational wave signal on 14th September 2015. The signal was named after the date as GW15094. It comes from a spectacular cosmic event happened 1.3 billion light-year away: a pair of black holes spiraled and merged into each other (\cref{fig:gravitational-wave}). The black holes were 36 and 29 times the mass of the Sun and formed a new black hole of 62 times the mass of the Sun. The \enquote{ripples,} namely the gravitational wave, in spacetime caused by their enormous gravitational pull travelled 1.3 billion light-years across the universe to reach Earth -- gravitational waves propagate at the speed of light according to Einstein's Theory of Relativity. Physicists in LIGO spent several months to analyze the data; they verified and finally announced on 11th February 2016: this was the first detection of gravitational waves, confirming the prediction Einstein made a century earlier. Through the sound waves converted from the signal by physicists, people heard the sound of deep universe for the first time.
...
\index{octave}
It was the study of the sound of universe 2500 years ago, that Pythagoras discovered the theory of music. A legend said when Pythagoras passed a blacksmith's shop, he noticed various sounds produced by hammering on anvil. Georg Friedrich Händel, a music in Baroque period, composed a piano suite named \emph{Air and Five Variations on The Harmonious Blacksmith} (HWV430) in 1720. It was said Pythagoras observed hammers of different sizes produced consonant sounds; some were harmonic, others were not. By investigation and experiment, Pythagoras found the harmonic sounds were produced by the hammers of numerical weights of 12, 9, 8, and 6. This was the beginning of music theory. Basically, Pythagoras identified below ratios:
...
Lyre was a popular instrument with seven strings used by ancient Greeks as shown in \cref{fig:lyre}; it often symbolizes music. Pythagoras might obtain an octave from half a string ($\frac{1}{2}$ length), obtain the perfect fifth from $\dfrac{2}{3}$ length of a string, and the perfect fourth from $\dfrac{3}{4}$ length of a string. \Cref{fig:octave} shows the tunes.
...
Pythagoras established his music theory that greatly influenced the west based on mathematics, specifically based on \emph{fractions and ratio}. He thought the universe was a giant lyre, with the known seven celestial bodies (including Sun, Moon, the five planets of Mercury, Venus, Mars, Jupiter, and Uranus) as strings, vibrating at different tunes. In this way, Pythagoras believed the sound of universe was essentially numbers.

\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.4]{img/octave}
 \caption{The next C spans an octave, where the ratio of the lengths of the string is $2:1$; G spans a perfect fifth from C, which corresponds to the ratio of $3:2$; F spans a perfect fourth from C, which corresponds to the ratio of $4:3$.}
 \label{fig:octave}
\end{figure}

The history of fraction is longer than that of zero or negative numbers. In \emph{The Zuo Tradition (Zuozhuan): Commentary on the ‘Spring and Autumn Annals,’} a book about Chinese history from 770 - 476 BCE, the author documented that the capital city of a state should not be larger than the imperial city. The Chinese categorized cities into three sizes: large, medium, and small. For the large cities, the area should be less than one third of the imperial city; for the medium, the area should be less than one fifth; for the small, the area should be less than one ninth. However, these terms, such as \enquote{one third,} might not be really fractions, as people hadn't used them in arithmetic calculation yet. Among the \emph{Chu bamboo slips} (dating to the middle to late Waring State period, no earlier than 305 BCE) collected by Tsinghua University, there was a \enquote{calculation table} being used by ancient Chinese to multiply numbers up to 99. In this table, there are dedicated rows and columns for $\times \dfrac{1}{2}$, which list the multiplication result\citepage[p20-22]{CaoNa-2017} of $\dfrac{1}{4}, \dfrac{1}{2}, 1\dfrac{1}{2}, 2\dfrac{1}{2}, \dotsc, 4\dfrac{1}{2}$. The Chinese developed complete arithmetic rules for fractions no later than Han Dynasty (\cref{sec:chinese-fractions}). Fractions appeared earliest in ancient Egypt.

\section{Egyptian fractions}
\index{Papyrus}

We know about Egyptian fractions mainly from two historic documents: Rhind papyrus (\cref{fig:rhind-papyrus}) and Moscow papyrus (\cref{fig:moscow-papyrus}). Papyrus was the writing material which was widely used in ancient Egypt. \emph{Cyperus papyrus} (family Cyperaceae), also called paper plant, is long cultivated in the Nile delta region. People collected its stalk or stem, cut the central pith into thin strips, pressed together, and dried to form a smooth thin writing surface. The Greeks and later Romans also adopted papyrus for writing. It was replaced by other less-expensive materials by the 3rd century CE in Europe, and people stopped using it around the 12th century. The two treasured documents in papyrus record the mathematical achievement in ancient Egypt. One was bought in 1858 in a Nile resort town by a Scottish antiquary, Alexander Henry Rhind, hence its name; it is collected in the British Museum. Rhind papyrus is a mathematical textbook around 1650 BCE; the author was Ahmes (hence is also called the Ahmes papyrus); it includes 85 math problems and their solution. The other one, Moscow papyrus, also known as the Golenischev Papyrus, was discovered and acquired by Vladimir Golenischev, a Russian Egyptologist, in 1893. It is now housed in the Pushkin State Museum of Fine Arts in Moscow, which gives the artifact its name. It was the work by some unknown author around 1890 BCE including 25 math problems.
...
The two artifacts evidently show that the Egyptians could solve problem with fractions. However, all nominators of their fractions were 1. This feature is so unique, that people call them \emph{Egyptian fractions} or unit fractions. In Hieroglyphic (see \cref{sec:rosetta-stone}), the Egyptian draw an \enquote{eye} over a number $a$ as the notation for $\dfrac{1}{a}$. \Cref{fig:egyptian-fractions} shows $\dfrac{1}{5}$ and $\dfrac{1}{15}$ respectively in Hieroglyphic. The meaning of the unit fraction is obvious, for example, $\dfrac{1}{3}$ means one out of the three equally divided parts (one third); $\dfrac{1}{5}$ means one out of the five divided parts (one fifth); in general, $\dfrac{1}{a}$ is one out of the $a$ equally divided parts.
...
The Egyptians didn't use fractions like $\dfrac{3}{4}$ or $\dfrac{2}{7}$ as their nominators were not 1. Instead, they decomposed them as the sum of unit fractions, for example: $\dfrac{3}{4} = \dfrac{1}{2} + \dfrac{1}{4}$, written as the left part of \cref{fig:sum-egyptian-fractions}. The symbol in the middle likes two walking legs. It means addition if the walking direction is same as the writing direction, and means subtraction if reversed. The right part of \cref{fig:sum-egyptian-fractions} is the decomposition of $\dfrac{2}{5} (= \dfrac{1}{3} + \dfrac{1}{15})$. The Egyptians only allowed distinct unit fractions in decomposition, hence $\dfrac{2}{7}$ should not be decomposed to $\dfrac{1}{7} + \dfrac{1}{7}$, but $\dfrac{1}{4} + \dfrac{1}{28}$. Sometimes, it is impossible to decompose into only two unit fractions, for example, in Rhind papyrus, $\dfrac{2}{29}$ was decomposed to $\dfrac{2}{29} = \dfrac{1}{24} + \dfrac{1}{58} + \dfrac{1}{174} + \dfrac{1}{232}$. The decomposition may not be unique, for example, $\dfrac{2}{29} = \dfrac{1}{15} + \dfrac{1}{435} = \dfrac{1}{16} + \dfrac{1}{232} + \dfrac{1}{464}$. Basically, as there is no obvious pattern or easy rules to find a decomposition, it's hard to master Egyptian fractions. In order to support fraction calculation, the Egyptians had to make big decomposition table for reference.
...
We haven't found any direct documents giving clues about why the Egyptians developed such special fractions and rules. One legend said: a farmer, in his will, wanted to divide his 17 horses among his three sons in the following proportions: $\dfrac{1}{2}$ to the eldest, $\dfrac{1}{3}$ to the second, and $\dfrac{1}{9}$ to the youngest. After their father's death, the three sons were not able to divide the horses for it resulted in fractional horse, nobody wanted to kill any horses. They sought the counsel of a wise old man in the village. The old man lent them a horse for dividing; with $17 + 1 = 18$ horses, the eldest son got $18 \times \dfrac{1}{2} = 9$ horses; the second son got $18 \times \dfrac{1}{3} = 6$ horses; the youngest son got $18 \times \dfrac{1}{9} = 2$ horses, and there remained $18 - 9 - 6 - 2 = 1$ horse, such that they returned it to the old man. This story can be interpreted in Egyptian fractions as,
...
Although very popular, this legend can \emph{not} be the origin of Egyptian fractions. We've found similar stories in many peoples, including the Arabs, the Indians, the Hebrews, the Chinese, and so on. Henry Dudeney collected this puzzle in his popular book \emph{Modern Puzzles and how to solve them} in 1926. In different versions, the animals vary from horses, camels, to elephants; the number and dividing portions vary too, such as, the three sons need to divide 11 animals into portions of $\dfrac{1}{2}$, $\dfrac{1}{4}$, and $\dfrac{1}{6}$, which corresponds to:

\[
\frac{11}{12} = \frac{1}{2} + \frac{1}{4} + \frac{1}{6}
\]

\Cref{qn:three-sons} asks to give all possible numbers and dividing portions. The earliest such story was from an Iranian philosopher, Mulla Muhammad Mahdi Naraqi's work in the 18th century. Though there were inheritance dividing problems in Rhind papyrus, they were all about evenly dividing. For example, problem 63\citepage[p15]{MKlein-1972} was about to divide 700 breads to four persons in the following proportions: $\dfrac{2}{3}$ to the first, $\dfrac{1}{2}$ to the second, $\dfrac{1}{3}$ to the third, and $\dfrac{1}{4}$ to the fourth\footnote{$\dfrac{2}{3}$ was few of the special values needn't be decomposed to unit fractions in Egypt.}. Ahmes solved it in the way that likes equation:

\[
\frac{2}{3}x + \frac{1}{2}x + \frac{1}{3}x + \frac{1}{4}x = 700
\]

He summed $\dfrac{2}{3}$, $\dfrac{1}{2}$, $\dfrac{1}{3}$, and $\dfrac{1}{4}$ to $1\dfrac{3}{4} (= 1 + \dfrac{1}{2} + \dfrac{1}{4})$, then divided 1 by $1\dfrac{3}{4}$ to obtain $\dfrac{4}{7} = (\dfrac{1}{2} + \dfrac{1}{14})$, finally, $700 \times \dfrac{4}{7} = 400$, which was the answer $x = 400$. This is exactly how students solving equations of one unknown in primary school. Note that the third and fourth persons get breads in fraction.

In some opinion, Egyptian fractions divide things more economically. Considering to divide 5 breads to 8 persons equally, the regular way is to divide each bread into 8 pieces, so everyone takes 5 pieces as shown in \cref{fig:evenly-devide}. The Egyptians might find a better way than this as shown in \cref{fig:egyptian-devide}, where everyone get a half and $\dfrac{1}{8}$ bread.
...
Do you have any idea why the Egyptians developed such special fractions? On one hand, it's so complex that finally disappeared in history; on the other hand, it brings interesting problems with hindsight: mathematicians thought about: (1) Can every fraction be decomposed into Egyptian fractions?  (2) if yes, then what is the best decomposition? The first problem was solved by Fibonacci in 1202 in \emph{Liber Abaci}. The second one led to a conjecture that hasn't been solved till now. Let us start from two easier problems:

\index{Egyptian fraction!decomposition}
\begin{proposition} Any Egyptian fraction can be decomposed into two distinct Egyptian fractions, that is, $\dfrac{1}{n} = \dfrac{1}{a} + \dfrac{1}{b}$. \label{th:egyptian-fraction-split}
\end{proposition}
...
\begin{proof}
  \begin{align*}
    \frac{2}{n} &= \frac{1}{n} + \frac{1}{n} && \\
                &= \frac{1}{n} + \frac{1}{n+1} + \frac{1}{n(n+1)} & \text{by \cref{th:egyptian-fraction-split}} & \qedhere
  \end{align*}
\end{proof}

We can obtain a better result when $n$ is odd: $\dfrac{2}{n}$ can be decomposed into two Egyptian fractions.

\begin{proof}
  \begin{align*}
    \frac{1}{n} &= \frac{1}{n+1} + \frac{1}{n(n+1)} & \text{by \cref{th:egyptian-fraction-split}} & \\
...
\begin{proof}
Fibonacci applied the division with remainder: $a = bq + r$ where $q$ is the quotient\footnote{The term quotient derives from the Latin word \emph{quotiēns}, which is an adverb meaning ``how many times'' or ``how often''.}, $r$ is the remainder, and $0 < r < b$. The fraction that is most close to and less than $\dfrac{b}{a}$ is $\dfrac{1}{q + 1}$, and their difference is,
\[
...
\index{greedy method}
Fibonacci always chose the unit fraction that was the \emph{closest} to $\dfrac{b}{a}$. Such strategy is called the \emph{greedy} method. However, it is not necessary the best decomposition. For example,
...
We define the \enquote{best} decomposition to be the one with the \underdot{fewest} Egyptian fractions, if two ways of decomposition share the same number of Egyptian fractions, the less denominator the better. \Cref{app:best-egyptian-decomposition} gives an algorithm that searches the best decomposition. Because Fibonacci's method reduces the nominator by 1 at least each time, the decomposition of $\dfrac{b}{a}$ consists of $b$ Egyptian fractions at most. The above example of $\dfrac{5}{121}$ evidently implies there may be better solution than the Fibonacci's. Erdős and Straus conjectured in 1950, that any natural number $n$ greater than 1 can always be decomposed into three Egyptian fractions, \index{Erdős-Straus conjecture}
...
When looking back, the Egyptian fractions were hard to use and compute, and in side way out of the main stream of mathematical history. It has more formal significance than its practical applications. Neither the Greeks nor the Romans developed fractions in arithmetic independently, instead they introduced dedicated terms to represent partial quantities. A unit of weight was \emph{as} and the \emph{unica} (from which derived \enquote{ounce} in English) was a twelfth part of the \emph{as}. \Cref{tab:roman-fractions} lists most used ancient Roman terms for partial quantities\cite{Miller-2025}.
...
\begin{table}[htbp]
  ...
  \hline
  $\frac{5}{12}$ & quincunx & five uncia & $\frac{1}{48}$ & sicilicus &  a quarter of uncia \\
  \hline
  $\frac{6}{12}$ & semis    & half    & $\frac{1}{72}$ & scriptulum    &  one sixth of uncia \\
  \hline
...
Many terms are persisted in our present languages. For example, from \enquote{semi,} the term of $1/2$, derived semicircle, semicolon, semiconductors and so on. The term \enquote{quadrans} for $\dfrac{1}{4} = \dfrac{3}{12}$ became \enquote{quarter} in English, where derived phrases like, \enquote{a quarter of an hour} and \enquote{a quarter of a year.}

\index{Babylonian decimals}
We know Babylonian fractions from material evidence: a tablet collected in Yale University as shown in \cref{fig:babylonian-yale}. It was inscribed a square and its diagonal. Near a side of the square inscribed 30 (3 wedges on up right), below the diagonal inscribed 42, 25, 35, and along the diagonal inscribed 1, 24, 51, 10. We learned from school math that the length of the diagonal is $\sqrt{2}$ times of the side, hence is $30 \times \sqrt{2} \approx 30 \times 1.4142 = 42.426$ for the side of 30. Note that the integral part, 42, is the first number inscribed below the diagonal. Considering the Babylonians used sexagesimal (base-60), are the followed numbers 25 and 35 the fractional part? Let's verify:
...
is exactly the fractional part of $42.426$. It showed that the Babylonians correctly gave the length of the diagonal: the value of 60-based numbers 42, 25, 35 is $42.426 \approx 30 \times \sqrt{2}$. Is the sequence of 1, 24, 51, 10 another fraction? Let's try:

\[
1 + \frac{24}{60} + \frac{51}{60^2} + \frac{10}{60^3} \approx 1.414213
\]

It is the approximation of $\sqrt{2}$, with precision up to 6 places! While these numbers are ambiguous for lack of the point symbol, for example, 12, 15 may represent $12 \times 60 + 15 = 720$ or $12 + \dfrac{15}{60} = 12.25$. Moreover, the Babylonians didn't use zero in a unified way, people have to guess the exact value from the context.

As the base of 60 was big enough, the Babylonian could get sufficiently fine quantity from $\dfrac{1}{60}$ to $\dfrac{59}{60}$. With 2 to 3 places, the fractional part was precise enough for daily life or astronomical observation. Besides, the base of 60 has plenty of proper factors\footnote{A factor being not of 1 or $n$ is called proper factor of $n$.} including 2, 3, 4, 5, 6, 10, 12, 15, 20, 30, hence has less chance to repeat when dividing (comparing to 10, which only has two proper factors of 2 and 5, leads to repeating decimals in common, see \cref{thm:cyclic-decimal}). These might be the reasons that the Babylonians didn't develop general fractions.

\section{Chinese fractions}
\label{sec:chinese-fractions}

\index{Nine chapters on the Art of mathematics}
People find complete arithmetic rules of fractions with varies of problems from \emph{Nine chapters on the Art of mathematics}, a classic Chinese mathematical book in Han Dynasty (about 1st century CE, often abbreviated as \emph{Nine chapters}). There was a dedicated chapter (see \cref{fig:jiuzhang}) about fractions. It started from the notation of ``$a$分之$b$'', meaning $\dfrac{b}{a}$, which is still using by the Chinese nowadays. The denominator $a$ comes first then follows with $b$; read as out of $a$ parts taken $b$. The Chinese used mixed number, for example, 8 steps and $\dfrac{1}{3}$ step to measure the length of a piece of land. They derived the notion of fractions from division, for example in the \emph{Nine chapters}: seven merchants sold four horses, each merchant sold $\dfrac{4}{7}$ horse.
...
After giving the notation of fractions, the author of \emph{Nine chapters} next dealt with the problem whether the value of a fraction was definitive, in other word, will multiple notations correspond to the same value? This led to the reduction operation and the concept of the lowest terms (irreducible fraction). The author explained with examples:

\begin{enumerate}[1)]
\item For twelve eighteenth ($\dfrac{12}{18}$), if reduce to its lowest terms, what is the result? The answer is two third. ($\dfrac{12}{18} = \dfrac{2}{3}$)
\item For forty nine ninety-first ($\dfrac{49}{91}$), if reduce to its lowest terms, what is the result? The answer is seven thirteenth. ($\dfrac{49}{91} = \dfrac{7}{13}$)
\end{enumerate}

\index{Euclidean algorithm} \label{sec:gcd-minus}
In order to reduce a fraction to its lowest terms, the author of \emph{Nine chapters} gave a method which was exactly known as the Euclidean algorithm in the west, \enquote{First, halve the nominator and denominator repeatedly if both are even; second, for the two numbers of the nominator and denominator, subtract the less one from the greater one repeatedly until they become the same value; finally, reduce the fraction with this value.} For fraction $\dfrac{b}{a}$, if both $a$ and $b$ are even, divide each by 2 and repeat; otherwise, denote the greatest common divisor of $a$ and $b$ by $(a, b)$, then,
...
If $a = b$, then their greatest common divisor is $a$ (or $b$). If $a > b$, then subtract $b$ from $a$; it turns the original problem of finding the greatest common divisor of $a$ and $b$, to a new problem of finding the greatest common divisor of $a - b$ and $b$. If $a < b$, then subtract $a$ from $b$; the original problem turns to finding the greatest common divisor of $a$ and $b - a$. Euclidean algorithm (we delay its proof to \cref{sec:Euclidean-algorithm}) calculates the great common divisors much faster\footnote{The improved Euclidean algorithm in practice implements the repeat of subtraction in \cref{eq:gcd-minus} as division, which calculates in logarithmic time. For numbers of 100 digits, it can find the greatest common divisor in about 8 recursions.} than the method of factorization, which needs to first factorize $a$ and $b$ into primes, then pick the most common factors and calculate their product. It is suitable for computer implementation and becomes a basic and very important algorithm in number theory and cryptography\footnote{Euclidean algorithm is also important in abstract algebra, such as ring and field theory.}. Below example shows the steps to find the greatest common divisor of 18 and 12 with Euclidean algorithm.

\[
(18, 12) = (18 - 12, 12) = (6, 12) = (6, 12 - 6) = (6, 6) = 6
\]

It gives the greatest common divisor in three steps. One may next reduce $\dfrac{12}{18}$ to its lowest terms by dividing the nominator and denominator by 6: $\dfrac{12}{18} = \dfrac{12/6}{18/6} = \dfrac{2}{3}$. The author of \emph{Nine chapters} next introduced addition of fractions with below examples:
...
The author explained, \enquote{let the sum of the products of each denominator and the other nominator be the resulted nominator; let the product of the two denominators be the resulted denominator.} that is,

\be
\frac{b}{a} + \frac{d}{c} = \frac{bc + ad}{ac}
\ee

As the result may not be the lowest terms, the author continued with a special case, \enquote{the result is 1 if the nominator equals the denominator,} and followed with the mixed number for the general case. At last the author addressed the special simple case of equal denominators, \enquote{one adds the nominators directly.}

\be
\frac{b}{a} + \frac{c}{a} = \frac{b + c}{a}
\ee

For addition, the author of \emph{Nine chapters} didn't convert the fractions to their terms with the least common denominator, but merely multiplied the denominators. We skip the subtraction part in \emph{Nine chapters} as it is similar to addition. When comparing two fractions, it's not so obvious which one is greater as with natural numbers, for example between $\dfrac{4}{7}$ and $\dfrac{3}{5}$. The author gave a remarkable general rule, which was essentially to compare with zero by converting the two fractions of $\dfrac{b}{a}$ and $\dfrac{d}{c}$ to the difference of $bc$ and $ad$. After defining the mean value of multiple fractions, the author extended it to the applications like, \enquote{Now there are seven persons dividing the money of eight and one third, how much does each individual get? The answer is one and four twenty-first for each,} that is $8\dfrac{1}{3} \div 7 = 1\dfrac{4}{21}$. The author explained, \enquote{Put the number of persons as the denominator, the total money as the nominator, then reduce it to the lowest terms.} The author did not consider the application of fractional denominator. The last part was about the multiplication of fractions:
...
The rule, given by the author was, \enquote{The denominator and nominator are the product of the two denominators and nominators respectively.} then converted the result to mixed number. Interestingly, there was a dedicated part about the multiplication of mixed numbers:
...
Evidently, the Chinese recognized the importance of fractions: the \emph{Nine chapters} actually started from the chapter of fractions, and all the following chapters about areas, shapes, equations, and so on were based on fractions.

\section{Hindu fractions and decimals}

\index{Hindu fractions}
The notation for fractions we are using comes from India, which wrote the nominator above the denominator without the fraction line. For example,
...
\index{fraction line}
denotes three fourth. The fraction line that separating the nominator and denominator was introduced by the Arabs around 1200 CE\cite{Pumfrey-2011}, thus it became,

\[
\dfrac{3}{4}
\]

Fibonacci was the first who introduced the modern notation of fractions to Europe. However, he adopted the right to left writing direction from the Arabs, consequently, the fractional part was written to the left of the integral part\cite{Miller-2025}. The fraction line posed considerable printing difficulties; Thomas Twining, the founder of renowned British Twining Tea company, used a slash instead of a horizontal fraction line in accounting book in 1718, like: 1/4 pound of tea. It makes printing and typing fractions easy with a typewriter. Today, many word processing and editing applications support typing fractions in \LaTeX convention, for example, the input \lstinline|\frac{b}{a}| renders $\dfrac{b}{a}$.

\index{decimal} \index{Liu Hui}
With Hindu-Arabic numeral system, the Arabic mathematicians introduced decimals. For example, Al-Kashi (920 - 980 CE) in his \emph{al-Risali al-mohitije} (Treatise on the circumference) wrote $\pi$ as \enquote{sah-hah 3 14159} where sah-hah means the integral part (corresponding to sahih in Turkish today) 3, followed by the decimal part. There hadn't been the point symbol yet. Liu Hui, a Chinese mathematician of the Wei-Jin period (c. 225 - 295 CE, \cref{fig:liuhui}) who annotated the \emph{Nine chapters}, was not satisfied with the value 3 of $\pi$ in ancient times. He decided to approximate it with decimals. When using a regular 96-gon to approximate the circle, he obtained the circumference of $314\dfrac{169}{625}$ cun\footnote{1 cun $\approx$ 2.31 cm in Han Dynasty.} with a diameter of 100 cun. He thought this value, which was about 3.14, exceeded $\pi$; he further doubled the edges to 192-gon, which approximated to $314\dfrac{4}{25} = 314.16$ cun.
...
Is every decimal a sum of fractions with denominators of 10, 100, 1000, ...? Conversely, does every fraction corresponds to a \emph{unique} decimal? For instance, 0.125 = $\dfrac{1}{10} + \dfrac{2}{100} + \dfrac{5}{1000}$, is the sum of fractions of $\dfrac{1}{10}$, $\dfrac{2}{100}$, and $\dfrac{5}{1000}$. In general a decimal $0.a_1 a_2 \dots a_n$ can be expressed as:
...
\begin{proof}
  For every decimal place $0 \leq a_i \leq 9$, the sum
  \begin{align*}
...
Though the fact of $0.a_1a_2\cdots \leq 1$ looks obvious, it's a remarkable mathematical and logical statement that the sum of infinitely many positive values are finite. It's the key to solve a paradox with a history over two thousand years. The Greek philosopher Zeno of Elea (c. 490 - 425 BCE) designed four paradoxes; the first one called Achilles paradox was the most popular. Achilles, the greatest warrior in Trojan war according to Homer's \emph{Iliad}, was fleet-footed. However, Zeno argued that Achilles when started behind a slow-moving tortoise in a race, would never catch it up. Because Achilles must first reach the point $A$ where the tortoise started, by which time the tortoise would have moved ahead to point $B$; by the time Achilles traversed the distance to this latter point $B$, the tortoise would have moved ahead to another point $C$, and so on. Although the distance between Achilles and the tortoise got closer and closer, Achilles was always left behind the tortoise, as shown in \cref{fig:Achilles-paradox}.
...
This is counter our common sense. We learn from school math how to solve such problem through the method of \enquote{relative motion.} Denote the speed of the tortoise by $v_1$, the speed of Achilles by $v_2$; the relative speed of Achilles to the tortoise is $v_2 - v_1$. If the tortoise starts head of Achilles by $s$, then Achilles will catch up and overtake the tortoise by the time of $t = \dfrac{s}{v_2 - v_1}$. However, it was not until Galileo, that the concept of relative motion was established systematically. Zeno's argument seemed so sound that the paradox attracted many great minds in history. Lewis Carrol and Douglas Hofstadter took Achilles and the tortoise as figures in their literary works.

In Analysis, it's common to solve Achilles paradox with the concept of limitation. Alternatively, we may solve it with the tool, namely the decimal as the sum of fractions. Let's quantify the problem for easy understanding. Suppose Achilles was 10 times faster than the tortoise, i.e., $v_2 : v_1 = 10$; the tortoise started ahead by the distance $s = 100$ pous\footnote{1 pous $\approx$ 0.308 feet in ancient Greece.}. According to Zeno, Achilles needs first traverse $s = 100$ pous, by which time the tortoise will have moved $\dfrac{1}{10}s = 10$ pous ahead; then Achilles traverses this 10 pous, by which time the tortoise will have moved another$\dfrac{1}{100}s = 1$ pous, ... the total distance Achilles needs to traverse will be:

\[
s(1 + \frac{1}{10} + \frac{1}{100} + \cdots) = 100\times(1 + 0.1 + 0.01 + \cdots) = 100 \times 1.11\cdots = 111.11\cdots
\]

Suppose the fleet-footed Achilles runs 100 pous in 9 second; he needs run another 0.9 second for the next 10 pous, and another 0.09 second for the next 1 pous, ..., the total time will be:

\begin{align*}
9 + 0.9 + 0.09 + \cdots &= 9.99\cdots = 10 \times 0.99\cdots & \\
                        &= 10 \times 1 & \text{by \cref{th:cycle-of-9}} \\
                        &= 10
\end{align*}

Hence Achilles will catch up the tortoise in 10 seconds according to Zeno's logic.

\subsection{Repeating decimals}
\index{repeating decimals}
To convert irreducible fraction $\dfrac{b}{a}$ to decimal, one divides $b$ by $a$. The division terminates sometimes, for example, $\dfrac{1}{2} = 0.5$, $\dfrac{1}{8} = 0.125$, $\dfrac{1}{25} = 0.4$, otherwise repeating, for example, $\dfrac{1}{3} = 0.\dot{3} = 0.333\cdots$, $\dfrac{1}{7} = 0.\dot{1}\dot{4}\dot{2}\dot{8}\dot{5}\dot{7}$. In what condition does it terminate? and in what condition does not? It seems to depend on our luck; in fact, we are very unlucky: it repeats in common. Below theorem tells how unlucky we are.

\index{terminating decimals}
\begin{theorem} \label{thm:finite-decimal}
  An irreducible fraction $\dfrac{b}{a}$ can be expressed as terminating decimal if and only if $\dfrac{b}{a} = \dfrac{b}{2^{\alpha}5^{\beta}}$, where $\alpha$ and $\beta$ are non-negative integers.
\end{theorem}
...
Because the factors of the denominator $10^n = 2^n 5^n$ are all powers of 2 and 5, so are the factors of $a$ in the lowest term.
\end{proof}

It turns out if there is any factor besides 2 and 5 for any irreducible fraction, like 3, 7, 11, ... then the decimal does not terminate. We may extend this theorem to $b$-based decimal, which does not terminate if the denominator contains any factor that does not divide $b$. This explains why the repeating decimal $\dfrac{5}{12} = 0.41666\cdots$ terminates as Babylonian sexagesimal (60-based) of 0, 25; and why $\dfrac{5}{14}$ repeats even as Babylonian sexagesimal. In particular, any fractions not in the form of $\dfrac{b}{2^n}$ does not terminate as binary, which leads to rounding error in computer system.

The decimal of fractions either terminates or repeats (the next chapter shows that fraction can't produce non-terminating non-repeating decimal); among those repeating, some have periodic cycle of 1 digit, like $\dfrac{1}{3} = 0.\dot{3}$, some have cycle of 2 digits, like $\dfrac{5}{11} = 0.\dot{4}\dot{5}$, some even longer, like $\dfrac{1}{7} = 0.\dot{1}\dot{4}\dot{2}\dot{8}\dot{5}\dot{7}$; some is pure repeating, some is mixed, like $\dfrac{5}{12} = 0.41\dot{6}$. What are the rules behind?
...
The fraction of the repeating decimal $0.\dot{a_1} \dot{a_2} \cdots \dot{a_n}$ is $\dfrac{a_1 a_2 \cdots a_n}{99 \cdots 9} = \dfrac{a_1 a_2 \cdots a_n}{10^{n} - 1}$.
\end{proposition}
...
For irreducible proper fraction $\dfrac{b}{2^{\alpha} 5^{\beta} q}$, where $q$ can't be divided by 2 or 5, let $n = \max(\alpha, \beta)$, then the decimal starts repeating after the decimal point by $n$ places, and the periodic cycle contains $m$ digits, where the remainder of $10^{m}$ divided by $q$ is 1.
\end{theorem}
...
Which is the mixed number after multiplied by $10^n$, where $X$ is the whole number part satisfying $0 \leq X < 10^n$. Since the remainder of $10^{m}$ divided by $q$ is 1, it follows that $q$ divides $10^{m} - 1$:

\begin{align*}
  (10^{m} - 1) \frac{b'}{q} &= k b' = a_1 a_2 \cdots a_m & \text{is integral}\\
                \frac{b'}{q} &= \frac{a_1 a_2 \cdots a_m}{99\cdots9} & m\text{ digits of }9
\end{align*}
Which is a repeating decimal by \cref{th:cyclic-decimal}.
\end{proof}
...
Besides the Achilles paradox, the other three are: dichotomy paradox, arrow paradox, and the moving row paradox. The dichotomy paradox was about Atalanta, a virgin huntress in Greek mythology. Suppose Atalanta is going to walk to the end of a path. Before travelling there, she needs travel halfway; before traveling halfway, she needs travel a quarter; before traveling a quarter, she needs travel one-eighth, and so on (\cref{fig:dichotomy-paradox}). This description requires one to complete infinitely many tasks, which Zeno believed was impossible. The paradoxical conclusion then would be that travel over any finite distance can neither be completed nor begin, and so all motion must be an illusion. \Cref{qn:dichotomy-paradox} asks to solve this paradox with an extension of \cref{th:cycle-of-9}.
...
The moving row paradox, also known as the stadium paradox, is about dividing time into atomic points too. As in \cref{fig:Moving-rows-paradox}, there are three rows in the stadium. Each row being composed of an equal number of bodies. At the beginning, they are all aligned. Suppose in the smallest time duration, row A stays, row B moves to the right by a space unit, and row $\Gamma$ moves to the left by a space unit. Relative to row B, row $\Gamma$ moves two units. It implies there should be a time duration that $\Gamma$ moves by one unit relative to $B$, which turns out to be half of the smallest time duration. Since the smallest duration is atomic, it involves the conclusion that half a given time is equal to that time.
...
Although Zeno's paradoxes are easy to understand, the argument is confusing: motion and time are so real in our common sense, that Achilles must be able to catch up the tortoise. However, it is hard to solve Zeno's paradox. Aristotle, Archimedes, Russel, Weyl and etc., proposed varies of solutions to Zeno's paradoxes\cite{Britannica-Zeno-24}.
\end{mdframed}

\section{Fractions as numbers}
In some sense, fractions were quite different from natural numbers of 0, 1, 2, 3, ... a fraction has two components: nominator and denominator; it has different forms, including decimal, percentage, expression of division, and ratio ($a:b$), all are fractions essentially. The last two demonstrate a particular feature that natural numbers of 0, 1, 2, 3... do not have: $\dfrac{1}{2} = \dfrac{2}{4} = \dfrac{50}{100} = 3 \div 6 = 7:14 = \cdots$, a definitive value with \emph{multiple} representations. Varies of expressions may evaluate to the same value (or ratio).  Below are some questions when one wants to treat fractions and natural numbers uniformly as \enquote{numbers.}
...
For Q1, if $\dfrac{b}{a} = \dfrac{d}{c}$ holds, multiply $ac$ to both sides, it turns out $bc = ad$; this is known as \enquote{cross-multiplication} as shown in \cref{fig:cross-mul}. It also applies to the equation of ratios: the \enquote{inner} and \enquote{outer} products of $b : a = d : c$ are identical, i.e., $bc = ad$. This is because the two forms, fraction and ratio，are essentially same. In mathematics, we call a relation \enquote{$\sim$} \underdot{equivalence} if below three properties hold:
...
Obviously, the normal \enquote{=} satisfies them, hence is an equivalence relation. Let's verify $bc = ad$ is an equivalence relation. First for the reflective property, comparing $\dfrac{b}{a}$ with itself, it's plainly that $ab = ab$; next for symmetric property, if $bc = ad$ holds for $\dfrac{b}{a}$ and $\dfrac{d}{c}$, then $ad = bc$ also holds for $\dfrac{d}{c}$ and $\dfrac{b}{a}$; last for transitive property, if $bc = ad$ holds for $\dfrac{b}{a}$ and $\dfrac{d}{c}$, and $de = cf$ holds for $\dfrac{d}{c}$ and $\dfrac{f}{e}$, multiply the two equations: $bcde = adcf$. Since the denominator $c \ne 0$, it can be canceled to give $bde = adf$. If $d \ne 0$, it can be further canceled to $be = af$; otherwise if $d = 0$, then $bc = ad = 0 = de = cf$, hence $b = f = 0$, which gives $be = af$ too. It follows that the relation holds for $\dfrac{b}{a}$ and $\dfrac{f}{e}$.
...
With this equivalence relation, one can tell if any two fractions (and ratios) equivalent. Among all equivalent fractions, we choose the $\dfrac{b}{a}$, where $a, b$ have no common divisor except 1 (their greatest common divisor $(a, b) = 1$, called coprime or relatively prime) as the \emph{representative}, which is called the irreducible fraction (or the lowest terms). The only exception is 0, which we chosen as the representative of $\dfrac{0}{a}$. Such representative is unique for if $\dfrac{b}{a} = \dfrac{d}{c}$ both are irreducible and their denominators are coprime, by the equivalence relation $bc = ad$, it implies $c$ divides $ad$; meanwhile since $c$ and $d$ are coprime, $c$ divides $a$. It follows that $a$ and $c$ divides each other, hence identical, i.e., $a = c$. In the same way, $b = d$, which shows the representative irreducible fraction is unique.

It's natural to ask why need such equivalence relation? why not just check if the fractions reduce to the same lowest terms? People did compare by reduction at the beginning as we've seen in the book of \emph{Nine chapters} and as what we were taught at school. However, as the numbers get bigger, people realized division is much harder than multiplication. For example, it's a bit hard to compare $\dfrac{8723}{22814}$ and $\dfrac{143}{374}$ by reduction even with a calculator or applying Euclidean algorithm. But it's easy to multiply, which is fast, and compare the product of $8723 \times 374 = 3262402$ and $22814 \times 143 = 3262402$, which are obviously identical. This equivalence relation can be extended to fractional expressions, for example, given $\dfrac{x^5 - 1}{x^3 - 1}$ and $\dfrac{1 + x + x^2 + x^3 + x^4}{1 + x + x^2}$, it's a bit hard to factorize\footnote{One solution is based on the obvious fact that $1^n - 1 = 0$, consequently, $x-1$ is a factor of $x^n-1$. Then by long division method, one can factorize it.} and reduce to the lowest terms, but multiplication is much easier:
...
It shows the two fractions equal. This justifies why mathematicians generalize the abstract concept of equivalence relation and choose the cross-multiplication as its application to fractions and ratios.

\vspace{3mm}
For Q2, we may reuse the method in the \emph{Nine chapters}, comparing through the difference of $\dfrac{b}{a} - \dfrac{d}{c}$ with 0. It amounts to comparing the nominators after reducing them to the same denominators. As any whole number $n$ equals $\dfrac{n}{1}$, we unify the comparison across whole numbers and fractions simply to between fractions. The ordering across whole numbers, fractions, and decimals sorts out their positions on the number line.

\vspace{3mm}
For Q3, the arithmetic operations were also given in the \emph{Nine chapters}, which can be summarized as: for $+/-$, reduce to the common denominator then add/subtract the nominators; for $\times$, multiply the nominators and denominators respectively, followed by reduction. The reciprocal of a number $n \ne 0$ is $\dfrac{1}{n}$ because $n\dfrac{1}{n} = \dfrac{n}{n} = 1$. If $n$ is fractional, expressed as $\dfrac{b}{a}$, then its reciprocal is $\dfrac{a}{b}$ because $\dfrac{b}{a}\dfrac{a}{b} = 1$. It shows that a fraction is itself a expression of division, hence the reciprocal is a bridge between division and multiplication:
...
Return to the legend of Pythagoras. After the discovery of the theory of music that fractions rule the harmonic sound, how to tune the seven strings of a lyre? If add an eighth string for an octave, then its length should be half of the first string. Pythagoras found overlapping a perfect fifth (ratio $3:2$) to a perfect four (ratio $4:3$) was an octave because $\dfrac{3}{2} \times \dfrac{4}{3} = 2$. He used the ratio $3:2$ of a perfect fifth as the basis scale and multiplied a geometric series:
...
where the last four are greater than 2, which exceed an octave. Pythagoras divided them by either 2 or 4, which mapped them back to the octave, then reordered them to:

\[
1, \frac{9}{8}, \frac{81}{64}, \frac{4}{3}, \frac{3}{2}, \frac{27}{16}, \frac{243}{128}, \frac{2}{1}
\]

It gives the ratio of each tone to the base. To list the ratio between each adjacent tones, he calculated the quotient between every two numbers:
...
\index{tonality}
In music theory, the greater ratio $9:8$ is called a whole tone (step, W), the less ratio $256:243$ is called a semitone (half step, H). This list, W - W - H - W - W -W - H, is called a major scale. Musical works based on major scale typically create sense of warmth, cheerfulness, and resolution. Another type, known as minor scale, which shifts the list to W - H - W - W - H - W - W; it typically creates sense of mellowness and introspection. Is there a harmonic 12-tone equal temperament? Unfortunately, it was out of what Pythagoras could design with fractions. To work out a 12-tone totality, we need setup 5 whole tones, 2 semitones, in total $5 \times 2 + 2 = 12$ ratios within an octave of $2:1$, which satisfy:

\[
1 = \alpha^0, \alpha^1, \alpha^2, \alpha^3, \alpha^4, \alpha^5, \alpha^6, \alpha^7, \alpha^8, \alpha^9, \alpha^{10}, \alpha^{11}, \alpha^{12} = 2
\]

It has a solution: $\alpha = \sqrt[12]{2}$, but is not a fraction! While pursuing the sound of heaven, let's continue our journey of numbers.

\begin{Exercise}[label={ex:fractions}]
\Question{The term \enquote{harmonic mean} comes after Pythagoras's music theory. Pythagoras was trying to insert a string with length $h$ between two strings with lengths of $a$ and $b$, such that they produce harmonic sound. He found the reciprocal of $h$ is at the \enquote{middle} of the reciprocals of $a$ and $b$, which is, \index{harmonic mean}
\[
\frac{1}{h} - \frac{1}{a} = \frac{1}{b} - \frac{1}{h}
\]

That is why the harmonic mean is also known as the mean of reciprocals. Verify that: 1) A boat travels between $A$ and $B$ with different speed: go at $v_1$ and return at $v_2$, then the average speed $v$ is the harmonic mean of $v_1$ and $v_2$; 2) Connect two resisters $R_1$ and $R_2$ in parallel, it's equivalent to connect \emph{two} same resisters of $R$, where $R$ is the harmonic mean of $R_1$ and $R_2$.
}

\Question{*Verify $\dfrac{2}{p} = \dfrac{1}{a} + \dfrac{1}{b}$ implies $(2a - p)(2b - p) = p^2$, and use this fact to show: for any prime $p$ greater than 2, $\dfrac{2}{p}$ can be \underdot{uniquely} decomposed into two Egyptian fractions as $\dfrac{2}{p} = \dfrac{1}{a} + \dfrac{1}{b} (a \ne b)$.\label{qn:unique-decompose-r}}

\Question{Show that Erdős-Straus conjecture is true for every even number $n$.}
...
\Question{*For the puzzle that three sons divide $n$ animals in the proportions of $\dfrac{1}{a}$, $\dfrac{1}{b}$, and $\dfrac{1}{c}$, where the eldest gets more than the second, the second gets more than the youngest, and they return the borrowed one at last, find all possible $n, a, b, c$. You may write a program to enumerate all solutions, but this exercise can be solved manually. Hint: the problem is to find all solutions in integers for the equation $\dfrac{n}{n+1} = \dfrac{1}{a} + \dfrac{1}{b} + \dfrac{1}{c}$, where $a < b < c$. Since every son gets at least an animal, what is the least $n$? How to show that $a$ can not exceed 3, hence can only be 2? \label{qn:three-sons}}

\Question{*By $0.999\cdots = 1$, any terminating decimal has two forms: $X.a_1a_2 \cdots a_m000\cdots$ and $X.a_1a_2 \cdots b999\cdots$, where $b = a_m - 1$ and $X$ is the whole number part. Show that, except for this special case, the decimal of any value $x$ is unique, where $0 < x < 1$.}

\Question{Show that the fraction of any repeating decimal $0.\dot{a_1} \dot{a_2} \cdots \dot{a_n}$ is $\dfrac{a_1 a_2 \cdots a_n}{99 \cdots 9} = \dfrac{a_1 a_2 \cdots a_n}{10^{n} - 1}$. \label{qn:cyclic-decimal}}

\Question{Use fractions and \cref{th:cycle-of-9} to show: Atalanta first traverses $\dfrac{1}{2}$ distance, then traverses half of the remaining, which is $\dfrac{1}{4}$ distance, and repeats, she will walk to the end of the path. Hint: using sum of fractions and binary decimal.\label{qn:dichotomy-paradox}}
...
\Question{Verify $\dfrac{2}{p} = \dfrac{1}{a} + \dfrac{1}{b}$ implies $(2a - p)(2b - p) = p^2$, and use this fact to show: for any prime $p$ greater than 2, $\dfrac{2}{p}$ can be \underdot{uniquely} decomposed into two Egyptian fractions as $\dfrac{2}{p} = \dfrac{1}{a} + \dfrac{1}{b} (a \ne b)$.
  ...
  \end{align*}
  Since $p$ is prime, $p^2$ can only have factors of 1, $p$, or $p^2$; by $a \ne b$, we rule out $p$, and let $2a - p = 1$ and $2b - p = p^2$, hence,
  \[
  a = \frac{p+1}{2}, b = \frac{p(p+1)}{2}
  \]
  As $p$ is odd prime, $p + 1$ is even, hence both $a$ and $b$ are integral, thereby,
  \[
...
\vspace{2mm}
We give a pure mathematical solution, followed with a \enquote{brute force} program for comparison. The problem amounts to finding all natural numbers satisfying the equation:

\[
\frac{n}{n+1} = \frac{1}{a} + \frac{1}{b} + \frac{1}{c}, a < b < c
\]

With the one borrowed animal, the sons are able to divide $n+1$ animals into three parts of $\dfrac{n + 1}{a}$, $\dfrac{n + 1}{b}$, and $\dfrac{n + 1}{c}$, whose sum is $n$, such that they can return the last animal. Let $n' = n + 1$, be the number including the borrowed animal, we write above equation in $n'$ as:
...
We need decrease $n'$ by 1 to give $n$ finally. With the one borrowed animal, $a, b, c$ all divide $n'$. We shall first show: the eldest son can get only $\dfrac{1}{2}$ animals, hence, $a$ can only be 2.
...
The youngest son gets at least an animal; what the second son gets are more than this, which are at least two; and the eldest gets even more, which are at least three; plus the borrowed one animal, the sum $n' > 3 + 2 + 1 = 6$, hence,
...
As $a, b, c$ all divide $n'$ and $a = 2$, $n'$ must be even. We claim $n' > 6$ as above, the first even number being greater than 6 is 8, hence,
...
\vspace{3mm}
We write a program to enumerate all possible $a, b, c$, and test whether the sum of their reciprocals being the form of $\dfrac{n + 1}{n}$. We enumerate $a$ from 2, 3, 4, ... As $a < b < c$, we enumerate $b$ from $a + 1$ and enumerate $c$ from $b + 1$. We need estimate the upper limits of $a, b, c$ such that the program terminates. Since $a < b < c$, the upper limit of $c$ is also the upper limit of $a$ and $b$. The youngest son gets at least 1 animal, hence, $c \leq n'$, we deduce from \cref{eq:equation-of-inherit}:

\begin{align*}
  1 - \frac{1}{n'} &= \frac{1}{a} + \frac{1}{b} + \frac{1}{c} \\
  1 - \frac{1}{n'} - \frac{1}{c} &= \frac{1}{a} + \frac{1}{b} \leq \frac{1}{2} + \frac{1}{3} = \frac{5}{6} \\
  \frac{1}{6} &\leq \frac{1}{n'} + \frac{1}{c} \leq \frac{1}{c} + \frac{1}{c} & \text{The youngest son gets at least 1, } \frac{1}{n'} \leq \frac{1}{c} \\
...
\Question{Show that the fraction of any repeating decimal $0.\dot{a_1} \dot{a_2} \cdots \dot{a_n}$ is $\dfrac{a_1 a_2 \cdots a_n}{99 \cdots 9} = \dfrac{a_1 a_2 \cdots a_n}{10^{n} - 1}$.

  \begin{proof}
    \begin{align*}
    \text{let } x &= 0.\dot{a_1} \dot{a_2} \cdots \dot{a_n} \\
...
\Question{Use sum of fractions to show: Atalanta first traverses $\dfrac{1}{2}$ distance, then traverses half of the remaining, which is $\dfrac{1}{4}$ distance, and repeats, she will walk to the end of the path.
...
\begin{align*}
  \frac{b}{a} + \frac{d}{c} &= \frac{bc + ad}{ac} \\
  &= \frac{ad + bc}{ac} & \text{apply the commutative law to the nominator} \\
