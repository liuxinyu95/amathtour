...
\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.5]{img/napier}
 \caption{纳皮尔肖像，1616年油画，爱丁堡大学收藏}
 % https://www.britannica.com/biography/John-Napier
 \label{fig:napier}
\end{figure}

1530年，鲁道夫（Christoff Rudolff，1499?～1545?年 ）使用一条数线分隔整数和小数部分。后来马吉尼（Magini，1555年～1617年）将竖线改进成了小数点，但并未得到广泛使用。直到20年后英国学者约翰·纳皮尔（John Napier，1550年～1617年，见\cref{fig:napier}）发明对数时使用小数点，现代小数形式才被广泛接受。
