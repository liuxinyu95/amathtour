...
%% \cref{qn:best-egyptian-decompose}提供了用贪心策略分解埃及分数的计算机程序。
...
%% \Question{$\bigstar$斐波那契的方法保证即约真分数$\frac{b}{a}$最多可以分解为$b$个埃及分数。我们可以机械化地找出“最优”分解，即用最少的埃及分数分解。若这样的分解不止一个，则分母的值越小越好。\lebel{qn:best-egyptian-decompose}
%%   \begin{enumerate}[1)]
