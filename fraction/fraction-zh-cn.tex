...
古希腊的乐器叫做里尔琴（Lyre），是一种七弦琴（见\cref{fig:lyre}）。我们推测毕达哥拉斯把琴弦的一半，也就是$\frac{1}{2}$张紧弹奏，获得了8度音；把琴弦的$\frac{2}{3}$张紧弹奏，获得了5度音；把琴弦的$\frac{3}{4}$张紧弹奏，获得了4度音；这些音调之间的关系如\cref{fig:octave}所示。
...
\begin{figure}[htbp]
 ...
 \caption{两个C间隔8度，琴弦比$2:1$；C与G间隔5度，C与F间隔4度。}
 \label{fig:octave}
\end{figure}
