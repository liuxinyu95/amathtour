...
乘法交换律：
\[
\frac{b}{a}\frac{d}{c} = \frac{bd}{ac} = \frac{db}{ca} = \frac{d}{c}\frac{b}{a}
\]

乘法结合律：
\[
\frac{b}{a}\frac{d}{c}\frac{f}{e} = \frac{bdf}{ace} = \frac{b(df)}{a(ce)} = \frac{b}{a}\frac{df}{cd} = \frac{b}{a}(\frac{d}{c}\frac{f}{e})
\]
}
\end{Answer}
