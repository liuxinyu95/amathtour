...
\begin{figure}[htbp]
  ...
  \subcaptionbox{古埃及象形文字，又称圣书体，代表献给神明的文字。共14行\label{fig:rosetta-hieroglyphs}}{\includegraphics[scale=0.5]{img/Rosetta-Hieroglyphs}}
  \caption{罗赛塔石碑上的三种文字}
...
通过对古文字的破译，我们发现古埃及大约在公元前3400年就出现了表示数字的符号。是众多古文明中最早的（美索不达米亚大约在公元前3000年出现了数字符号，中国大约在公元前1600年出现了数字符号）。
