...
其中$a_i$是被命名的数字，包括0、1、2……$b-1$。$n$写为$a_ma_{m-1} \cdots a_0$。例如$2025 = 2 \times 10^3 + 0 \times 10^2 + 2 \times 10 + 5$, 其中$b = 10, m = 3, a_3 = 2, a_2 = 0, a_1 = 2, a_0 = 5$，恰好也写为2025。我们再看一正一反两个例子：
...
\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.35]{img/sexagenary-chinese}
 \caption{干支纪年}
